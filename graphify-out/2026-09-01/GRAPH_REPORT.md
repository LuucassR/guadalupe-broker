...
## Corpus Check
- 72 files · ~48,613 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 451 nodes · 678 edges · 33 communities (21 shown, 12 thin omitted)
...
9. `CoverageTier` - 8 edges
10. `formatPriceARS()` - 8 edges
...
### Community 0 - "site.ts"
Cohesion: 0.06
Nodes (47): metadata, GROUP_LABELS, GROUP_ORDER, ICON_MAP, metadata, CoverageDetailPage(), generateMetadata(), ICON_MAP (+39 more)

### Community 1 - "dependencies"
Cohesion: 0.06
Nodes (37): ai, @ai-sdk/anthropic, framer-motion, gsap, @gsap/react, lucide-react, next, dependencies (+29 more)
...
### Community 6 - "cooperacion.ts"
Cohesion: 0.08
Nodes (28): POST(), quoteSchema, CoverageTier, CooperacionConfig, cooperacionProvider, CooperacionQuoteRow, CooperacionResponse, LocalidadRow (+20 more)
...
Cohesion: 0.06
Nodes (54): leadSchema, vehicleDetailsSchema, GET(), Cotizador(), CURRENT_YEAR, fetchVehicleLookup(), YEARS, PriceComparison() (+46 more)
...
Cohesion: 0.13
Nodes (14): name, private, scripts, build, cooperacion:smoke, dev, import:cca, lint (+6 more)
...
## Knowledge Gaps
- **197 isolated node(s):** `metadata`, `Props`, `ICON_MAP`, `metadata`, `ICON_MAP` (+192 more)
...
- **Why does `CoverageTier` connect `cooperacion.ts` to `pricing.ts`?**
