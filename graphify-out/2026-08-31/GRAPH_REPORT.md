# Graph Report - guadalupe-broker  (2026-08-31)

## Corpus Check
- 69 files · ~45,114 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 415 nodes · 634 edges · 33 communities (22 shown, 11 thin omitted)
...
7. `Lucas David Rossi` - 9 edges
8. `CoverageTier` - 8 edges
9. `formatPriceARS()` - 8 edges
10. `YaMayorista - E-Commerce` - 8 edges
...
### Community 0 - "site.ts"
Cohesion: 0.06
Nodes (46): metadata, GROUP_LABELS, GROUP_ORDER, ICON_MAP, metadata, CoverageDetailPage(), generateMetadata(), ICON_MAP (+38 more)
...
Cohesion: 0.08
Nodes (25): eslint, eslint-config-next, devDependencies, eslint, eslint-config-next, @playwright/test, prettier, prettier-plugin-tailwindcss (+17 more)
...
Cohesion: 0.12
Nodes (20): POST(), quoteSchema, CoverageTier, matchCoverageTier(), TIER_PATTERNS, getEnabledProviders(), getProvider(), PROVIDERS (+12 more)
...
Cohesion: 0.09
Nodes (33): leadSchema, vehicleDetailsSchema, PriceComparison(), PriceComparisonProps, Fetched, SancorColumnInput, SancorPlan, SancorQuoteColumn() (+25 more)
...
Cohesion: 0.10
Nodes (18): Agregar un proveedor nuevo, Alta en el portal (una sola vez), Autenticación (2 piezas), Convención de env vars, El contrato `QuoteProvider`, Env vars, Flujo, graphify (+10 more)
...
### Community 15 - "import-cca-catalog.ts"
Cohesion: 0.22
...
### Community 26 - "Cotizador.tsx"
Cohesion: 0.15
Nodes (19): GET(), Cotizador(), CURRENT_YEAR, fetchVehicleLookup(), YEARS, FranquiciaPct, globalForPrisma, CatalogBrand (+11 more)

### Community 28 - "scripts"
Cohesion: 0.14
Nodes (13): name, private, scripts, build, dev, import:cca, lint, postinstall (+5 more)
...
Cohesion: 0.29
Nodes (4): BRANDS, MODELS, SANCOR_PLANS, VERSIONS
...
## Knowledge Gaps
- **175 isolated node(s):** `metadata`, `Props`, `ICON_MAP`, `metadata`, `ICON_MAP` (+170 more)
...
- **Why does `dependencies` connect `dependencies` to `scripts`, `import-cca-catalog.ts`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `CoverageTier` connect `sancor.ts` to `pricing.ts`, `Cotizador.tsx`?**
