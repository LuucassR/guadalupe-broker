...
| `cotizador-ui.spec.ts`      | El paso 2 del flujo **Auto** muestra la estimación propia **+ una columna por aseguradora** (`PROVIDER_COLUMNS`: Sancor y Cooperación con sus marcas) y todas con precios; el flujo **Moto** muestra sólo Cooperación. **Red mockeada** (sin DB ni catálogo). | `pnpm dev`          |
